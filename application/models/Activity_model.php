...
class Activity_model extends MY_Model
{
  ...
  public function activities( $start = 0 , $limit = NULL )
  {
      ...
      $this->select('activity_type.name AS type_name');
      $this->join(
        'activity_type',
        'activity_type.id = activities.type_id',
        'join'
      );
      $this->offset( $start );
  ...
  public function get_activity_by_type( $type_id ) {
      $this->where($this->table.'.type_id', $type_id);
      $this->activities(  );
